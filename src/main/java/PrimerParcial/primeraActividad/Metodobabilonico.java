 ...
 * @author isaac
 */
public class Metodobabilonico extends javax.swing.JFrame {

    /**
     * Creates new form Metodobabilonico
     */
    public Metodobabilonico() {
        initComponents();
    }
    ...
    private void btncalcularActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (txtNumero.getText().isEmpty() || TxtDecimales.getText().isEmpty() || TxtError.getText().isEmpty() || !esNumerico(txtNumero.getText()) || !esNumerico(TxtDecimales.getText()) || !esNumerico(TxtError.getText()) || !esMayorCero(txtNumero.getText()) || !esMayorCero(TxtDecimales.getText()) || !esMayorCero(TxtError.getText()) || Double.parseDouble(TxtError.getText()) >= 1 || Double.parseDouble(TxtDecimales.getText()) <= 0 || !esEntero(TxtDecimales.getText())) {
            ...
            if (!txtNumero.getText().isEmpty() && esNumerico(txtNumero.getText()) && esMayorCero(txtNumero.getText())) txtNumero.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
            if (!TxtDecimales.getText().isEmpty() && esNumerico(TxtDecimales.getText()) && esMayorCero(TxtDecimales.getText()) && Double.parseDouble(TxtDecimales.getText()) > 0 &&  esEntero(TxtDecimales.getText())) TxtDecimales.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
            if (!TxtError.getText().isEmpty() && esNumerico(TxtError.getText()) && esMayorCero(TxtError.getText()) && Double.parseDouble(TxtError.getText()) < 1) TxtError.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    private void btnborrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnborrarActionPerformed
        ...
        TxtDecimales.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        TxtError.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Metodobabilonico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Metodobabilonico().setVisible(true);
            }
        });
    }
